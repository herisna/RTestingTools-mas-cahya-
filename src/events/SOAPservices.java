...
public class SOAPservices extends Event2{
    ...
    public void getISORecharge(String MSISDN, String rcgAmount, String splitCode) throws Exception
    {
        String Response=ws.ISORecharge(MSISDN, rcgAmount, splitCode, this.SecureTicket);
        setResponseData(Response);
    }
